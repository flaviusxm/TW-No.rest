          ...
          {!user ? (
            <>
              ...
              <button
                ...
                className="mx-auto flex items-center justify-center gap-3 bg-white border border-[#ccc] rounded-full px-6 py-3 shadow-md hover:shadow-lg transition"
              >
                <img
            ...
            <div className="text-center">
              <p className="mb-4 text-[#4E8DC4]/80">
                Logged in as <strong>{user.email}</strong>
              </p>
              <button
                onClick={handleLogout}
                className="bg-[#FEDB59] text-[#1f2937] font-semibold py-2 px-6 rounded-lg hover:shadow-lg transition"
              >
                Log out
              </button>
            </div>
